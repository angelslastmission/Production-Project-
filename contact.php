...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($full_name === '' || $email === '' || $message === '') {
        ...
        $safeType    = htmlspecialchars($message_type, ENT_QUOTES, 'UTF-8');
        ...
        $plainBody = "Name: {$full_name}\nEmail: {$email}\nType: {$message_type}\n\nMessage:\n{$message}";

        $result = petcura_send_system_email($toEmail, $toName, $subject, $htmlBody, $plainBody);
...
<main class="contact-page">
  ...
  <div class="container contact-body">
    ...
    <div class="contact-alert-error d-flex align-items-center gap-3">
      ...
      <div><strong>Message could not be sent.</strong> Please check the required fields and mail configuration.</div>
    </div>
    <?php endif; ?>
      ...
      <div class="col-lg-5 d-flex flex-column gap-3">
          ...
          <div class="contact-info-item">
            ...
            <div>
              ...
              <div class="contact-info-val">
                <a href="mailto:petcura37@gmail.com" class="contact-email-link">petcura37@gmail.com</a>
              </div>
            </div>
          </div>
        ...
        <div class="contact-faq-card">
          ...
          $faqs = [
            ...
            ["bi-people", "Who can use PetCura?", "Veterinarians and pet owners — each has a separate dashboard with role-specific access."],
          ];
