    ...
    <main class="vet-main">
        ...
        <section class="vet-panel">
            <div class="vet-panel-header">
                <h3 class="vet-panel-title">My Profile</h3>
                <?php if (!$is_edit_mode): ?>
                <a href="settings.php?edit=1" class="btn" style="background: #0d9488; color: #fff;">
            ...
            <form method="POST" id="profileSettingsForm" class="p-3 p-md-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="first_name" class="form-control" <?= $is_edit_mode ? '' : 'readonly' ?> value="<?= htmlspecialchars($form_data['first_name']) ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-secondary">Last name <span style="color: #dc2626;">*</span></label>
                        <input type="text" name="last_name" class="form-control" <?= $is_edit_mode ? '' : 'readonly' ?> value="<?= htmlspecialchars($form_data['last_name']) ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-secondary">Email <span style="color: #dc2626;">*</span></label>
                        <input type="email" name="email" class="form-control" <?= $is_edit_mode ? '' : 'readonly' ?> value="<?= htmlspecialchars($form_data['email']) ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-secondary">Phone</label>
                        <input type="text" name="phone" class="form-control" <?= $is_edit_mode ? '' : 'readonly' ?> value="<?= htmlspecialchars($form_data['phone']) ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-secondary">Clinic name</label>
                        <input type="text" name="clinic_name" class="form-control" <?= $is_edit_mode ? '' : 'readonly' ?> value="<?= htmlspecialchars($form_data['clinic_name']) ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-secondary">Clinic address</label>
                        <input type="text" name="clinic_address" class="form-control" <?= $is_edit_mode ? '' : 'readonly' ?> value="<?= htmlspecialchars($form_data['clinic_address']) ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-secondary">Reminder window</label>
                        <select name="reminder_window" class="form-select" <?= $is_edit_mode ? '' : 'disabled' ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="email_notifications" class="form-select" <?= $is_edit_mode ? '' : 'disabled' ?>>
                ...
                <div class="mt-3 d-flex gap-2 justify-content-end">
                    <a href="settings.php" class="btn btn-light">Cancel</a>
                    <button type="submit" class="vet-alert-btn">Save Changes</button>
                </div>
                <?php endif; ?>
            </form>
        </section>
