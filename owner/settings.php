...
<div class="owner-layout">
    ...
    <main class="owner-main">
        <section class="owner-greeting" style="margin-bottom: 20px;">
            <h1>Settings</h1>
            <p>Manage password and account security for your owner account.</p>
        </section>
        ...
        <section class="owner-panel" style="margin-bottom: 20px;">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px;">
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 16px;">
                    <div style="font-size: 0.8rem; color: #334155; font-weight: 600; text-transform: uppercase;">Account</div>
        ...
        <section class="owner-panel">
            <div class="owner-panel-header" style="margin-bottom: 12px;">
                <h3 class="owner-panel-title">Change Password</h3>
            </div>
